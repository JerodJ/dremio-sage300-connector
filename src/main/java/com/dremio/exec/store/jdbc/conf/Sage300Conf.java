...
@SourceType(value = "Sage300ARP", label = "Sage300",uiConfig = "sage300-layout.json")
public class Sage300Conf extends AbstractArpConf<Sage300Conf> {
  private static final String ARP_FILENAME = "arp/implementation/sage300-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.sage300.Sage300Driver";
